...
```{r Analysis Part One Tuned parameters}
...
trees_folds <- vfold_cv(all_train)
...
# TODO: Determine if we even want to try this; clean description data if so (ex. remove website links and other unnecessary info)

# Encoding
all_videos_df
test <- mutate(all_videos_df,
                   description = iconv(description, from = "UTF-8", to = "ASCII//TRANSLIT", 
                                sub = "byte"),
               description = tolower(description),
               description = str_remove(description, pattern = "(\n|<br />)"), # Remove new lines and breaks
